...
export function AppSidebarClient({
  ...
  return (
    ...
    >
          ...
          return (
            <li key={href}>
              ...
              >
                {active && (
                  <span
                    className="absolute bottom-2 left-0 top-2 w-[2.5px] rounded-full bg-primary"
                    aria-hidden
                  />
                )}
      ...
      <div className="mt-auto px-2 pb-4 pt-2 lg:px-0">
        <div
          className={cn(
            "flex items-center",
            collapsed ? "justify-center" : "justify-start lg:px-3",
          )}
        >
          <UserMenu 
